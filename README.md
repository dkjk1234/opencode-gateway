...
The final operator readiness report also checks GitHub `main`, the VPS checkout, systemd services, the public gateway E2E result, and the published Windows installer manifest:
